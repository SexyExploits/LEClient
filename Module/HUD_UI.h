...
namespace HUD_UI {
	...
	public:
		...
		XUI_IMPLEMENT_CLASS(Tab_LiveEmulation, L"Tab_LiveEmulation", XUI_CLASS_SCENE)
			XUI_BEGIN_MSG_MAP()
	...
	public:
		...
		CXuiCheckbox chkCustomNotify, chkLEImage, chkGuideInfo, chkColorFade, chkGradient, chkGradientBtns, chkGradientBG;
		CXuiControl btnSave;

		XUI_IMPLEMENT_CLASS(Tab_UI, L"Tab_UI", XUI_CLASS_SCENE)
			XUI_BEGIN_MSG_MAP()
			XUI_ON_XM_NOTIFY_PRESS(ButtonMonitor)
			XUI_ON_XM_INIT(OnInit)
	...
	public:
		...
		XUI_IMPLEMENT_CLASS(Tab_Bypasses, L"Tab_Bypasses", XUI_CLASS_SCENE)
			XUI_BEGIN_MSG_MAP()
			XUI_ON_XM_NOTIFY_PRESS(ButtonMonitor)
			XUI_ON_XM_INIT(OnInit)
			XUI_END_MSG_MAP()
	...
	public:
		...
		XUI_IMPLEMENT_CLASS(Tab_Cheats, L"Tab_Cheats", XUI_CLASS_SCENE)
			XUI_BEGIN_MSG_MAP()
			XUI_ON_XM_NOTIFY_PRESS(ButtonMonitor)
			XUI_ON_XM_INIT(OnInit)
			XUI_END_MSG_MAP()
	...
	public:
		...
		XUI_IMPLEMENT_CLASS(Tab_Changes, L"Tab_Changes", XUI_CLASS_SCENE)
			XUI_BEGIN_MSG_MAP()
			XUI_ON_XM_NOTIFY_PRESS(ButtonMonitor)
			XUI_ON_XM_INIT(OnInit)
			XUI_END_MSG_MAP()
